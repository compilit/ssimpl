...
## 1.2 An identity document supported by cryptographic proof

All users of the SSIMPL protocol must possess a modern [Standardised e-passport](standardised-e-passports.md). These
...
## 2.2 Peer-to-peer data sharing/subscriptions and authentication
...
## 2.3 A Central, Neutral, Open-Source server
